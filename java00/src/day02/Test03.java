...
public class Test03 {
	public Test03() {
		...
		System.out.println("10+50 : " +sum+ " 입니다");
	}
	 ...
	 *  
	 				...
	 				return 명령의 의미는 이함수를 즉시 종료하세요 
	 			
	 			반환값 타입
	 				
	 				되돌려줄 데이터의 타입을 의미한다.
	 				만약 되돌려주질 데이터가 없는 경우 void 라고 기술한다.
	 *		예]
	 *			두수를 입력하면 두수(정수)를 더한 값을 반환해주는 기능을 가진 함수
